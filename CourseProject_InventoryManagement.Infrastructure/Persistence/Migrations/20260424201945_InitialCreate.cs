...
namespace CourseProject_InventoryManagement.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InventoryCustomIdRules",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InventoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PartOrder = table.Column<int>(type: "int", nullable: false),
                    PartType = table.Column<byte>(type: "tinyint", nullable: false),
                    Format = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    StaticTextValue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryCustomIdRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryCustomIdRules_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryFieldId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_InventoryId_CreatedAtUtc",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_CreatedAtUtc",
                table: "Inventories",
                column: "CreatedAtUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryCustomIdRules_InventoryId",
                table: "InventoryCustomIdRules",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryCustomIdRules_InventoryId_PartOrder",
                table: "InventoryCustomIdRules",
                columns: new[] { "InventoryId", "PartOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryFields_InventoryId_DisplayOrder",
                table: "InventoryFields",
                columns: new[] { "InventoryId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryFields_InventoryId_FieldType",
                table: "InventoryFields",
                columns: new[] { "InventoryId", "FieldType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemFieldValues_ItemId_InventoryFieldId",
                table: "ItemFieldValues",
                columns: new[] { "ItemId", "InventoryFieldId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemLikes_CreatedByUserId",
                table: "ItemLikes",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemLikes_ItemId_CreatedByUserId",
                table: "ItemLikes",
                columns: new[] { "ItemId", "CreatedByUserId" },
                unique: true);
