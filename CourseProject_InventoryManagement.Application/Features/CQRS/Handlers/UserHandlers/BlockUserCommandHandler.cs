...
{
    public class BlockUserCommandHandler : ICQRS.IBlockUser
    {
        private readonly IAppDbContext _context;
        private readonly IAuthenticatedUserService _authenticatedUserService;

        public BlockUserCommandHandler(IAppDbContext context, IAuthenticatedUserService authenticatedUserService)
        {
            _context = context;
            _authenticatedUserService = authenticatedUserService;
        }

        public async Task<Result<Guid>> BlockUser(BlockUserCommand command, CancellationToken cancellationToken = default)
        {
