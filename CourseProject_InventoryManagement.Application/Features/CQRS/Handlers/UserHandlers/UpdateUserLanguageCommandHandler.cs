...
{
    public class UpdateUserLanguageCommandHandler : ICQRS.IUpdateUserLanguage
    {
        private readonly IAppDbContext _context;
        private readonly IAuthenticatedUserService _authenticatedUserService;

        public UpdateUserLanguageCommandHandler(IAppDbContext context, IAuthenticatedUserService authenticatedUserService)
        {
            _context = context;
            _authenticatedUserService = authenticatedUserService;
        }

        public async Task<Result<UserDto>> UpdateUserLanguage(UpdateUserLanguageCommand command, CancellationToken cancellationToken = default)
        {
